...
!function (e, t, o) {
  ...
  function u(r, n, d, a, m, i, c, l, s) {
    function u(e) {
      return e[0] || e
    }

    var p = i.startSymbol(), E = i.endSymbol(), h = "{{" === p && "}}" === E, f = function (e, o, r) {
      var n = !1;
      if (e && e.length) {
      ...
      dom: {}, now: e.performance ? t.bind(e.performance, e.performance.now) : Date.now || function () {
        ...
        var i = !("rtl" == r[0].dir || "rtl" == r[0].body.dir);
        return 0 == arguments.length ? i ? "ltr" : "rtl" : void(i && t.isDefined(n) ? t.element(e).css(o, a(n)) : !i && t.isDefined(d) && t.element(e).css(o, a(d)))
      }, clientRect: function (e, t, o) {
        var r = u(e);
        t = u(t || r.offsetParent || document.body);
        var n = r.getBoundingClientRect(), d = o ? t.getBoundingClientRect() : {left: 0, top: 0, width: 0, height: 0};
        ...
        function r(e, o) {
          ...
          return n && n.length && n.length && t.forEach(n, function (e) {
            e = t.element(e);
            var o = e.hasClass("_md-autofocus");
            o && (r = e)
          }), r
        }
        ...
        function n(e) {
          ...
          e = t.element(e || m)[0];
          var r = 50, n = t.element('<div class="md-scroll-mask">  <div class="md-scroll-mask-bar"></div></div>').css("z-index", r);
          return e.appendChild(n[0]), n.on("wheel", o), n.on("touchmove", o), function () {
            n.off("wheel"), n.off("touchmove"), n[0].parentNode.removeChild(n[0]), delete b.disableScrollAround._enableScrolling
          }
        }

        function d() {
          var e = m.parentNode, t = e.style.cssText || "", o = m.style.cssText || "", r = b.scrollTop(m), n = m.clientWidth;
          return m.scrollHeight > m.clientHeight + 1 && (a(m, {
            position: "fixed",
            width: "100%",
            top: -r + "px"
          }), a(e, {overflowY: "scroll"})), m.clientWidth < n && a(m, {overflow: "hidden"}), function () {
            m.style.cssText = o, e.style.cssText = t, m.scrollTop = r, e.scrollTop = r
          }
        }
        ...
        return h ? e : e && t.isString(e) ? e.replace(/\{\{/g, p).replace(/}}/g, E) : e
  ...
  function p(e, o, r, n) {
    function d(e, r, n) {
      ...
      !d || d.hasAttribute(r) && 0 !== d.getAttribute(r).length || c(d, r) || (n = t.isString(n) ? n.trim() : "", n.length ? e.attr(r, n) : o.warn('ARIA: Attribute "', r, '", required for accessibility, is missing on node:', d))
    }
    ...
    function m(e, t) {
      var o = i(e) || "", r = o.indexOf(n.startSymbol()) > -1;
      r ? a(e, t, function () {
        return i(e)
      }) : d(e, t, o)
    }
    ...
    return {expect: d, expectAsync: a, expectWithText: m}
  }

  function E(e, o, r, n, d, a) {
    this.compile = function (m) {
      var i = m.templateUrl, c = m.template || "", l = m.controller, s = m.controllerAs, u = t.extend({}, m.resolve || {}), p = t.extend({}, m.locals || {}), E = m.transformTemplate || t.identity, h = m.bindToController;
      return t.forEach(u, function (e, o) {
        t.isString(e) ? u[o] = r.get(e) : u[o] = r.invoke(e)
      }), t.extend(u, p), i ? u.$template = o.get(i, {cache: a}).then(function (e) {
        return e.data
      }) : u.$template = e.when(c), e.all(u).then(function (e) {
        var o, r = E(e.$template, m), a = m.element || t.element("<div>").html(r.trim()).contents(), i = n(a);
        return o = {
          locals: e, element: a, link: function (r) {
            if (e.$scope = r, l) {
              var n = d(l, e, !0);
              h && t.extend(n.instance, e);
              var m = n();
  ...
  function f(o, r, n) {
    ...
    function a(e, t, o) {
      var r = q[t.replace(/^\$md./, "")];
      if (!r)throw new Error("Failed to register element with handler " + t + ". Available handlers: " + Object.keys(q).join(", "));
      return r.registerElement(e, o)
    }

    function m(e, r) {
      var n = new o(e);
      return t.extend(n, r), q[e] = n, u
    }
    ...
    var i = navigator.userAgent || navigator.vendor || e.opera, c = i.match(/ipad|iphone|ipod/i), l = i.match(/android/i), s = "undefined" != typeof e.jQuery && t.element === e.jQuery, u = {
      handler: m,
      register: a,
      isHijackingClicks: (c || l) && !s && !W
    };
    if (u.isHijackingClicks) {
      var p = 6;
      u.handler("click", {options: {maxDistance: p}, onEnd: d("click")}), u.handler("focus", {
    ...
    return u.handler("press", {
      ...
      options: {minDistance: 6, horizontal: !0, cancelMultiplier: 1.5}, onStart: function (e) {
        ...
        var o, r;
        e.preventDefault(), this.state.dragPointer ? this.dispatchDragMove(e) : (this.state.options.horizontal ? (o = Math.abs(t.distanceX) > this.state.options.minDistance, r = Math.abs(t.distanceY) > this.state.options.minDistance * this.state.options.cancelMultiplier) : (o = Math.abs(t.distanceY) > this.state.options.minDistance, r = Math.abs(t.distanceX) > this.state.options.minDistance * this.state.options.cancelMultiplier), o ? (this.state.dragPointer = A(e), N(e, this.state.dragPointer), this.dispatchEvent(e, "$md.dragstart", this.state.dragPointer)) : r && this.cancel())
      }, dispatchDragMove: r.throttle(function (e) {
        this.state.isRunning && (N(e, this.state.dragPointer), this.dispatchEvent(e, "$md.drag", this.state.dragPointer))
      }), onEnd: function (e, t) {
        this.state.dragPointer && (N(e, this.state.dragPointer), this.dispatchEvent(e, "$md.dragend", this.state.dragPointer))
      }
    }).handler("swipe", {
    ...
    return b.prototype = {
      ...
      start: function (e, o) {
        if (!this.state.isRunning) {
          ...
          this.state = {isRunning: !0, options: t.extend({}, this.options, n), registeredParent: r}, this.onStart(e, o)
        }
      },
      move: function (e, t) {
  ...
  function g(e, o) {
    function r(e) {
      ...
      t || e.$material || e.isIonicTap || T(e) || (e.preventDefault(), e.stopPropagation())
    }

    function n(e) {
      var t = 0 === e.clientX && 0 === e.clientY;
      t || e.$material || e.isIonicTap || T(e) ? (G = null, "label" == e.target.tagName.toLowerCase() && (G = {
        x: e.x,
        y: e.y
    ...
    function d(e, t) {
      var r;
      for (var n in q)r = q[n], r instanceof o && ("start" === e && r.cancel(), r[e](t, X))
    }

    function a(e) {
      if (!X) {
        var t = +Date.now();
        B && !_(e, B) && t - B.endTime < 1500 || (X = A(e), d("start", e))
      }
    }

    function m(e) {
      X && _(e, X) && (N(e, X), d("move", e))
    }

    function i(e) {
      X && _(e, X) && (N(e, X), X.endTime = +Date.now(), d("end", e), B = X, X = null)
    }

    document.contains || (document.contains = function (e) {
      return document.body.contains(e)
    }), !z && e.isHijackingClicks && (document.addEventListener("click", n, !0), document.addEventListener("mouseup", r, !0), document.addEventListener("mousedown", r, !0), document.addEventListener("focus", r, !0), z = !0);
  ...
  function A(e) {
    var t = k(e), o = {startTime: +Date.now(), target: e.target, type: e.type.charAt(0)};
  ...
  function N(e, t) {
    var o = k(e), r = t.x = o.pageX, n = t.y = o.pageY;
  ...
  function v() {
    function e(e) {
      ...
      function n(t, o) {
        ...
        return i.presets[t] = {methods: o.methods.concat(a), optionsFactory: o.options, argOption: o.argOption}, c
      }
        ...
        function b(u) {
          function p() {
            return r(function (e, t) {
              ...
              f(u).then(function (t) {
                k = b(t, u), v = _(k, u, t.controller).then(e, o)
              }, o)
            })
          }
          ...
          function E(e, o, n) {
            ...
            return k ? (u = t.extend(u || {}, n || {}), u.cancelAutoHide && u.cancelAutoHide(), u.element.triggerHandler("$mdInterimElementRemove"), u.$destroy === !0 ? T(u.element, u).then(function () {
              o && a(e) || d(e)
            }) : (r.when(v)["finally"](function () {
              T(u.element, u).then(function () {
                o && a(e) || d(e)
              }, a)
            }), N.deferred.promise)) : r.when(!1)
          }
          ...
          var N, k, v = r.when(!0);
          return u = h(u), N = {options: u, deferred: r.defer(), show: p, remove: E}
        }
  ...
  function H(e, r) {
    ...
    return d = {
      notFoundError: function (t, o) {
        ...
        if (!n(e))return null;
        var t, o, r;
        for (t = 0, o = a.length; o > t; t++)if (r = a[t], r.$$mdHandle === e)return r;
        return null
  ...
  function y(e) {
    function o(o, r, n) {
      return r.controller("mdNoInk") ? t.noop : e.instantiate($, {$scope: o, $element: r, rippleOptions: n})
    }

    return {attach: o}
  }

  function $(e, o, r, n, d, a, m) {
  ...
  function S(e) {
    function r(e, t) {
      return t = t || {}, V[e] = d(e, t), c
    }

    function n(e, o) {
      return d(e, t.extend({}, V[e] || {}, o))
    }

    function d(e, t) {
      var o = ce.filter(function (e) {
        return !t[e]
      });
    ...
    function a(e, o) {
      if (l[e])return l[e];
      o = o || "default";
      var r = "string" == typeof o ? l[o] : o, n = new m(e);
    ...
    function m(e) {
      function o(e) {
        if (e = 0 === arguments.length ? !0 : !!e, e !== r.isDark) {
          r.isDark = e, r.foregroundPalette = r.isDark ? J : Z, r.foregroundShadow = r.isDark ? ee : te;
          var o = r.isDark ? ie : me, n = r.isDark ? me : ie;
      ...
      var r = this;
      r.name = e, r.colors = {}, r.dark = o, o(!1), de.forEach(function (e) {
        var o = (r.isDark ? ie : me)[e];
        r[e + "Palette"] = function (n, d) {
          ...
          return Object.keys(a.hues).forEach(function (e) {
            ...
            if (-1 == ce.indexOf(t))throw new Error("Invalid hue value '%1' in theme %2's %3 color %4. Available hue values: %5".replace("%1", t).replace("%2", r.name).replace("%3", e).replace("%4", n).replace("%5", ce.join(", ")))
          }), r
        }, r[e + "Color"] = function () {
    ...
    function i(e, r) {
      function n(e) {
        return e === o || "" === e ? !0 : a.THEMES[e] !== o
      }

      function d(o, d) {
        function a() {
          return i = d.controller("mdTheme") || o.data("$mdThemeController"), i && i.$mdTheme || ("default" == s ? "" : s)
        }
        ...
        function m(e) {
          if (e) {
            ...
            t && o.removeClass("md-" + t + "-theme"), o.addClass("md-" + e + "-theme"), o.data("$mdThemeName", e), i && o.data("$mdThemeController", i)
          }
        }

        var i = d.controller("mdTheme"), c = o.attr("md-theme-watch"), l = (u || t.isDefined(c)) && "false" != c;
        m(a()), o.on("$destroy", l ? e.$watch(a, m) : t.noop)
      }

      var a = function (t, r) {
        r === o && (r = t, t = o), t === o && (t = e), a.inherit(r, r)
      };
      return a.THEMES = t.extend({}, l), a.PALETTES = t.extend({}, V), a.inherit = d, a.registered = n, a.defaultTheme = function () {
        return s
    ...
    V = {};
    var c, l = {}, s = "default", u = !1;
    return t.extend(V, e), i.$inject = ["$rootScope", "$log"], c = {
      definePalette: r,
      extendPalette: n,
      theme: a,
      ...
      $get: i,
      _LIGHT_DEFAULT_HUES: me,
      _DARK_DEFAULT_HUES: ie,
      _PALETTES: V,
      _THEMES: l,
      _parseRules: O,
      _rgba: U
  ...
  function O(e, o, r) {
    P(e, o), r = r.replace(/THEME_NAME/g, e.name);
    var n = [], d = e.colors[o], a = new RegExp(".md-" + e.name + "-theme", "g"), m = new RegExp("('|\")?{{\\s*(" + o + ")-(color|contrast)-?(\\d\\.?\\d*)?\\s*}}(\"|')?", "g"), i = /'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue\-[0-3]|shadow|default)-?(\d\.?\d*)?(contrast)?\s*\}\}'?"?/g, c = V[d.name];
    return r = r.replace(i, function (t, o, r, n, d) {
      return "foreground" === o ? "shadow" == r ? e.foregroundShadow : e.foregroundPalette[r] || e.foregroundPalette[1] : (0 !== r.indexOf("hue") && "default" !== r || (r = e.colors[o].hues[r]), U((V[e.colors[o].name][r] || "")[d ? "contrast" : "value"], n))
    }), t.forEach(d.hues, function (t, o) {
      var d = r.replace(m, function (e, o, r, n, d) {
        return U(c[t]["color" === n ? "value" : "contrast"], d)
      });
  ...
  function I(e, o) {
    function r(e, o) {
      var r = e.contrastDefaultColor, n = e.contrastLightColors || [], d = e.contrastStrongLightColors || [], a = e.contrastDarkColors || [];
      "string" == typeof n && (n = n.split(" ")), "string" == typeof d && (d = d.split(" ")), "string" == typeof a && (a = a.split(" ")), delete e.contrastDefaultColor, delete e.contrastLightColors, delete e.contrastStrongLightColors, delete e.contrastDarkColors, t.forEach(e, function (o, m) {
        function i() {
          return "light" === r ? a.indexOf(m) > -1 ? oe : d.indexOf(m) > -1 ? ne : re : n.indexOf(m) > -1 ? d.indexOf(m) > -1 ? ne : re : oe
        }

        if (!t.isObject(o)) {
          var c = j(o);
          if (!c)throw new Error("Color %1, in palette %2's hue %3, is invalid. Hex or rgb(a) color expected.".replace("%1", o).replace("%2", e.name).replace("%3", m));
          e[m] = {value: c, contrast: i()}
        }
      })
    }

    var n = document.head, d = n ? n.firstElementChild : null, a = !ue && e.has("$MD_THEME_CSS") ? e.get("$MD_THEME_CSS") : "";
    if (d && 0 !== a.length) {
      t.forEach(V, r);
      var m = a.split(/\}(?!(\}|'|"|;))/).filter(function (e) {
        ...
        return e.trim() + "}"
      }), i = new RegExp("md-(" + de.join("|") + ")", "g");
      de.forEach(function (e) {
        pe[e] = ""
      }), m.forEach(function (e) {
        for (var t, o = (e.match(i), 0); t = de[o]; o++)if (e.indexOf(".md-" + t) > -1)return pe[t] += e;
        for (o = 0; t = de[o]; o++)if (e.indexOf(t) > -1)return pe[t] += e;
        return pe[ae] += e
      }), le || t.forEach(o.THEMES, function (e) {
        Q[e.name] || L(e, e.name, se)
      })
    }
  }
  ...
  function L(e, t, o) {
    ...
    Q[t] || (de.forEach(function (t) {
      for (var d = O(e, t, pe[t]); d.length;) {
        var a = d.shift();
        if (a) {
          var m = document.createElement("style");
          m.setAttribute("md-theme-style", ""), o && m.setAttribute("nonce", o), m.appendChild(document.createTextNode(a)), r.insertBefore(m, n)
        }
      }
    }), e.colors.primary.name == e.colors.accent.name && console.warn("$mdThemingProvider: Using the same palette for primary and accent. This violates the material design spec."), Q[e.name] = !0)
  }

  function P(e, t) {
    if (!V[(e.colors[t] || {}).name])throw new Error("You supplied an invalid color palette for theme %1's %2 palette. Available palettes: %3".replace("%1", e.name).replace("%2", t).replace("%3", Object.keys(V).join(", ")))
  }
    ...
    return a = {
      translate3d: function (e, t, o, r) {
        ...
        function o() {
          ...
          return o ? a.clientRect(o) : null
        }

        var r = t.element, n = t.bounds;
        if (r || n) {
          var d = r ? a.clientRect(r) || o() : a.copyRect(n), m = a.copyRect(e[0].getBoundingClientRect()), i = a.centerPointFor(m), c = a.centerPointFor(d);
          return {
            centerX: c.x - i.x,
            centerY: c.y - i.y,
            scaleX: Math.round(100 * Math.min(.5, d.width / m.width)) / 100,
            scaleY: Math.round(100 * Math.min(.5, d.height / m.height)) / 100
          }
        }
        return {centerX: 0, centerY: 0, scaleX: .5, scaleY: .5}
      }, calculateZoomToOrigin: function (o, r) {
        var n = "translate3d( {centerX}px, {centerY}px, 0 ) scale( {scaleX}, {scaleY} )", d = t.bind(null, e.supplant, n);
        return d(a.calculateTransformValues(o, r))
      }, calculateSlideToOrigin: function (o, r) {
        var n = "translate3d( {centerX}px, {centerY}px, 0 )", d = t.bind(null, e.supplant, n);
        return d(a.calculateTransformValues(o, r))
      }, toCss: function (e) {
        function o(e, o, n) {
  ...
  t.module("material.core", ["ngAnimate", "material.core.animate", "material.core.layout", "material.core.gestures", "material.core.theming"]).config(n).run(r), r.$inject = ["$log", "$injector"], n.$inject = ["$provide", "$mdThemingProvider"], d.$inject = ["$delegate"], t.module("material.core").directive("mdAutofocus", a).directive("mdAutoFocus", a).directive("mdSidenavFocus", a), t.module("material.core").factory("$mdColorUtil", i), t.module("material.core").factory("$mdConstant", c), c.$inject = ["$sniffer"], t.module("material.core").config(["$provide", function (e) {
    e.decorator("$mdUtil", ["$delegate", function (e) {
      return e.iterator = l, e
    }])
  }]), t.module("material.core").factory("$mdMedia", s), s.$inject = ["$mdConstant", "$rootScope", "$window"];
  var Y = 0;
  t.module("material.core").factory("$mdUtil", u), u.$inject = ["$document", "$timeout", "$compile", "$rootScope", "$$mdAnimate", "$interpolate", "$log", "$rootElement", "$window"], t.element.prototype.focus = t.element.prototype.focus || function () {
      return this.length && this[0].focus(), this
    }, t.element.prototype.blur = t.element.prototype.blur || function () {
      return this.length && this[0].blur(), this
    }, t.module("material.core").service("$mdAria", p), p.$inject = ["$$rAF", "$log", "$window", "$interpolate"], t.module("material.core").service("$mdCompiler", E), E.$inject = ["$q", "$http", "$injector", "$compile", "$controller", "$templateCache"];
  var X, B, q = {}, W = !1, G = null, z = !1;
  t.module("material.core.gestures", []).provider("$mdGesture", h).factory("$$MdGestureHandler", M).run(g), h.prototype = {
    skipClickHijack: function () {
      return W = !0
    }, $get: ["$$MdGestureHandler", "$$rAF", "$timeout", function (e, t, o) {
      return new f(e, t, o)
    }]
  }, f.$inject = ["$$MdGestureHandler", "$$rAF", "$timeout"], g.$inject = ["$mdGesture", "$$MdGestureHandler"], t.module("material.core").provider("$$interimElement", v), function () {
    function e(e) {
      function a(e) {
      ...
      var i = /^((?:x|data)[\:\-_])/i, c = /([\:\-\_]+(.))/g, l = ["", "xs", "gt-xs", "sm", "gt-sm", "md", "gt-md", "lg", "gt-lg", "xl", "print"], s = ["layout", "flex", "flex-order", "flex-offset", "layout-align"], u = ["show", "hide", "layout-padding", "layout-margin"];
      ...
      return ["$timeout", function (o) {
        return {
          restrict: "A", priority: -10, compile: function (r) {
            return k.enabled ? (r.addClass(e), function (t, r) {
              o(function () {
                r.removeClass(e)
              }, 10, !1)
            }) : t.noop
      ...
      return ["$mdUtil", "$interpolate", "$log", function (r, n, d) {
        return h = r, f = n, b = d, {
          restrict: "A", compile: function (r, n) {
            var d;
            return k.enabled && (i(e, n, r, b), c(e, u(e, n, ""), l(r, e, n)), d = o), d || t.noop
          }
        }
      }]
    }
    ...
    function d(e) {
      ...
      return ["$mdUtil", "$interpolate", "$log", function (r, n, d) {
        return h = r, f = n, b = d, {
          restrict: "A", compile: function (r, n) {
            var d;
            return k.enabled && (c(e, u(e, n, ""), l(r, e, n)), o(null, r), d = o), d || t.noop
          }
        }
      }]
    }
    ...
    function i(e, t, o, r) {
      ...
      switch (e.replace(M, "")) {
        case"flex":
          "md-button" != m && "fieldset" != m || (d = "<" + m + " " + e + "></" + m + ">", a = "https://github.com/philipwalton/flexbugs#9-some-html-elements-cant-be-flex-containers", n = "Markup '{0}' may not work as expected in IE Browsers. Consult '{1}' for details.", r.warn(h.supplant(n, [d, a])))
      }
    }
    ...
    function E(e) {
      ...
      return e = e || "", 0 != e.indexOf("-") && 0 != e.indexOf(" ") || (e = "none" + e), t = e.toLowerCase().trim().replace(g, "-").split("-"), t.length && "space" === t[0] && (t = [t[0] + "-" + t[1], t[2]]), t.length > 0 && (o.main = t[0] || o.main), t.length > 1 && (o.cross = t[1] || o.cross), T.indexOf(o.main) < 0 && (o.main = "start"), N.indexOf(o.cross) < 0 && (o.cross = "stretch"), o
    }

    var h, f, b, M = /(-gt)?-(sm|md|lg|print)/g, g = /\s+/g, A = ["grow", "initial", "auto", "none", "noshrink", "nogrow"], _ = ["row", "column"], T = ["", "start", "center", "end", "stretch", "space-around", "space-between"], N = ["", "start", "center", "end", "stretch"], k = {
      enabled: !0,
      breakpoints: []
    };
    e(t.module("material.core.layout", ["ng"]))
  }(), t.module("material.core").factory("$mdComponentRegistry", H), H.$inject = ["$log", "$q"], function () {
    function e(e) {
      function o(e) {
  ...
  }(), t.module("material.core").factory("$mdInkRipple", y).directive("mdInkRipple", w).directive("mdNoInk", C).directive("mdNoBar", C).directive("mdNoStretch", C);
  var K = 450;
  w.$inject = ["$mdButtonInkRipple", "$mdCheckboxInkRipple"], y.$inject = ["$injector"], $.$inject = ["$scope", "$element", "rippleOptions", "$window", "$timeout", "$mdUtil", "$mdColorUtil"], $.prototype.color = function (e) {
    function o() {
  ...
  }, $.prototype.calculateColor = function () {
    return this.color()
  }, $.prototype._parseColor = function (e, t) {
    t = t || 1;
  ...
  }, $.prototype.handleMouseup = function () {
    x(this, this.clearRipples)
  }, $.prototype.handleTouchmove = function () {
    x(this, this.deleteRipples)
  }, $.prototype.deleteRipples = function () {
    for (var e = 0; e < this.ripples.length; e++)this.ripples[e].remove()
  }, $.prototype.clearRipples = function () {
  ...
  }, $.prototype.isRippleAllowed = function () {
    ...
    return !0
  }, $.prototype.inkRipple = function () {
    return this.$element.attr("md-ink-ripple")
  }, $.prototype.createRipple = function (e, o) {
    function r(e, t, o) {
    ...
    if (this.isRippleAllowed()) {
      ...
      }, .35 * K, !1), this.options.dimBackground && this.container.css({backgroundColor: u}), this.container.append(a), this.ripples.push(a), a.addClass("md-ripple-placed"), this.$mdUtil.nextTick(function () {
        a.addClass("md-ripple-scaled md-ripple-active"), n.$timeout(function () {
          n.clearRipples()
        }, K, !1)
      }, !1)
    }
  }, $.prototype.fadeInComplete = function (e) {
    this.lastRipple === e ? this.timeout || this.mousedown || this.removeRipple(e) : this.removeRipple(e)
  }, $.prototype.removeRipple = function (e) {
  ...
  }, $.prototype.fadeOutComplete = function (e) {
  ...
  }), t.module("material.core.theming", ["material.core.theming.palette"]).directive("mdTheme", D).directive("mdThemable", R).provider("$mdTheming", S).run(I);
  var V, Q = {}, Z = {
    name: "dark",
    1: "rgba(0,0,0,0.87)",
    2: "rgba(0,0,0,0.54)",
  ...
  }, ee = "1px 1px 0px rgba(0,0,0,0.4), -1px -1px 0px rgba(0,0,0,0.4)", te = "", oe = j("rgba(0,0,0,0.87)"), re = j("rgba(255,255,255,0.87)"), ne = j("rgb(255,255,255)"), de = ["primary", "accent", "warn", "background"], ae = "primary", me = {
    accent: {
      "default": "A200",
      "hue-1": "A100",
      "hue-2": "A400",
  ...
  }, ie = {background: {"default": "A400", "hue-1": "800", "hue-2": "900", "hue-3": "A200"}};
  de.forEach(function (e) {
    var t = {"default": "500", "hue-1": "300", "hue-2": "800", "hue-3": "A100"};
    me[e] || (me[e] = t), ie[e] || (ie[e] = t)
  });
  var ce = ["50", "100", "200", "300", "400", "500", "600", "700", "800", "900", "A100", "A200", "A400", "A700"], le = !1, se = null, ue = !1;
  S.$inject = ["$mdColorPalette"], D.$inject = ["$mdTheming", "$interpolate", "$log"], R.$inject = ["$mdTheming"];
  var pe = {};
  I.$inject = ["$injector", "$mdTheming"], t.module("material.core").factory("$$mdAnimate", ["$q", "$timeout", "$mdConstant", "$animateCss", function (e, t, o, r) {
    return function (n) {
      return F(n, e, t, o, r)
    }
    ...
    t.module("material.core.animate", []).factory("$$forceReflow", m).factory("$$AnimateRunner", c).factory("$$rAFMutex", i).factory("$animateCss", ["$window", "$$rAF", "$$AnimateRunner", "$$forceReflow", "$$jqLite", "$timeout", function (t, m, i, c, l, s) {
      function u(r, m) {
        ...
        var u = m.keyframeStyle || m.to && (m.duration > 0 || m.transitionStyle), h = !!m.addClass || !!m.removeClass, T = u || h;
        _(r, !0), M(r, m);
        var N, k, v = !1;
        return {
          close: t.close, start: function () {
            function t() {
              return v ? void 0 : (v = !0, N && k && r.off(N, k), p(r, m), b(r, m), o(c, function (t) {
                l.style[e(t[0])] = ""
              }), u.complete(!0), u)
            }
            ...
            return f(function () {
              ...
              var h = i.delay, f = 1e3 * h, b = i.duration, M = 1e3 * b, A = Date.now();
              N = [], i.transitionDuration && N.push(d), i.animationDuration && N.push(a), N = N.join(" "), k = function (e) {
                e.stopPropagation();
                var o = e.originalEvent || e, r = o.timeStamp || Date.now(), n = parseFloat(o.elapsedTime.toFixed(3));
                Math.max(r - A, 0) >= f && n >= b && t()
              }, r.on(N, k), g(r, m), s(t, f + 1.5 * M, !1)
            }), u
          }
        }
      }
      ...
      function E(e) {
        ...
        var n = A(e), d = t.getComputedStyle(n), a = h(d[o("transitionDuration")]), m = h(d[o("animationDuration")]), i = h(d[o("transitionDelay")]), c = h(d[o("animationDelay")]);
