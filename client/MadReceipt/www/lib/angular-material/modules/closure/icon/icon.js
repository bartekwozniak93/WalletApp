 ...
 *
 * @param {string} id Query value for a unique Id or URL. If the argument is a URL, then the service will retrieve the
 *     icon element from its internal cache or load the icon and cache it first. If the value is not a URL-type string,
 *     then an ID lookup is performed. The Id may be a unique icon ID or may include an iconSet ID prefix.
 *
